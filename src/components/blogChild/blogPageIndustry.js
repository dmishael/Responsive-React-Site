...
class BlogPageIndustry extends Component {
  state = {
    social: false,
    socialPosts: [
      {
  ...
  render() {
    return (
      <div className="BlogPage">
        ...
        <div class="blogMain">
          <div class="blogTitle">Industry News</div>
          <div class="blogPost container-fluid p-0">
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.industryPosts[0].image}
                ...
                <div class="col-md-8 ">
                  <div class="card-body">
                    <div class="blogPostTitle mt-5">
                      {this.state.industryPosts[0].title}
                    </div>
            ...
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.industryPosts[1].image}
                    class="card-img block"
                    alt="..."
                  />
                </div>
                <div class="col-md-8 m-0 p-0">
                  <div class="card-body">
                    <div class="blogPostTitle mt-5">
                      {this.state.industryPosts[1].title}
                    </div>
                    <a class="mt-5 d-flex justify-content-bottom" href="#">
                      <p class="internalButton">read more</p>
                    </a>
            ...
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.industryPosts[2].image}
                    class="card-img block"
                    alt="..."
                  />
                </div>
                <div class="col-md-8 m-0 p-0">
                  <div class="card-body">
                    <div class="blogPostTitle mt-5">
                      {this.state.industryPosts[2].title}
                    </div>
                    <a class="mt-5 d-flex justify-content-bottom" href="#">
                      <p class="internalButton">read more</p>
                    </a>
            ...
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.industryPosts[3].image}
                    class="card-img block"
                    alt="..."
                  />
                </div>
                <div class="col-md-8 m-0 p-0">
                  <div class="card-body">
                    <div class="blogPostTitle mt-5">
                      {this.state.industryPosts[3].title}
                    </div>
                    <a class="mt-5 d-flex justify-content-bottom" href="#">
                      <p class="internalButton">read more</p>
                    </a>
...
export default BlogPageIndustry;

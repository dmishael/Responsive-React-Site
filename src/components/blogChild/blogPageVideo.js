...
class BlogPageVideo extends Component {
  state = {
    social: false,
    socialPosts: [
      {
  ...
  render() {
    return (
      <div className="BlogPage">
        ...
        <div class="blogMain">
          <div class="blogTitle">Video</div>
          <div class="blogPost container-fluid p-0">
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.videoPosts[0].image}
            ...
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.videoPosts[1].image}
                    class="card-img block"
                    alt="..."
                  />
                </div>
            ...
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.videoPosts[2].image}
                    class="card-img block"
                    alt="..."
                  />
                </div>
            ...
            <div class="card">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img
                    src={this.state.videoPosts[3].image}
                    class="card-img block"
                    alt="..."
                  />
                </div>
